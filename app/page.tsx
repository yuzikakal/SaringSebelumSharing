    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900 transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center space-y-6">
          ...
          >
            ...
            Kendalikan ego dan jadilah netizen yang menjaga <span className="font-semibold text-slate-900 dark:text-white">Persatuan Indonesia</span> di era digital.
          </motion.p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-red-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-red-500 dark:shadow-none transition-all group">
              <CardHeader>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-amber-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-amber-500 dark:shadow-none transition-all group">
              <CardHeader>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-orange-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-orange-500 dark:shadow-none transition-all group">
              <CardHeader>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <motion.div 
          ...
          className="bg-gradient-to-r from-red-50 to-slate-50 border border-red-200 dark:from-red-950/50 dark:to-slate-900 dark:border-red-500/30 rounded-lg p-8 text-center space-y-4"
        >
          ...
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto">
            ...
            Menyebarkan informasi tanpa verifikasi adalah bentuk keserakahan digital yang mengkhawatirkan, 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-red-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-red-500 dark:shadow-none transition-all">
              <CardHeader>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-amber-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-amber-500 dark:shadow-none transition-all">
              <CardHeader>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-orange-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-orange-500 dark:shadow-none transition-all">
              <CardHeader>
                <CardTitle className="text-lg text-slate-900 dark:text-slate-100">Terjebak Ruang Gema</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {/* REVISI ANGKA: Lebih kuat secara visual dan akademis */}
                  <p className="text-4xl font-bold text-orange-500">76%</p>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Netizen Indonesia mengaku kesulitan membedakan fakta dan hoaks, membuat algoritma ruang gema semakin mudah memperkuat bias. <span className="italic">(Sumber: Survei Kaspersky)</span>
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }}>
            <Card className="h-full bg-white border-slate-200 hover:border-rose-500 shadow-sm dark:bg-slate-900 dark:border-slate-800 dark:hover:border-rose-500 dark:shadow-none transition-all">
              <CardHeader>
                <CardTitle className="text-lg text-slate-900 dark:text-slate-100">Krisis Kesantunan</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {/* REVISI ANGKA: 1 dari 3 lebih mudah dicerna daripada peringkat #29 */}
                  <p className="text-4xl font-bold text-rose-500">1 dari 3</p>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Satu dari tiga orang pernah melakukan atau menjadi korban ujaran kebencian online, merusak budaya kesantunan bangsa. <span className="italic">(Sumber: Microsoft DCI)</span>
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <motion.div 
          ...
          // REVISI UI: Hover effect dihapus agar tidak mengganggu fokus baca
          className="mt-10 bg-red-100 border border-red-200 dark:bg-red-950/40 dark:border-red-500/30 rounded-lg p-8 space-y-4"
        >
      ...
      <motion.section 
        ...
        className="bg-slate-100 border-t border-slate-200 dark:bg-slate-900/50 dark:border-slate-800 mt-16 py-12"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            ...
            <Link href="/kesimpulan">
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-slate-300 text-slate-900 hover:bg-slate-200 dark:border-slate-700 dark:text-slate-100 dark:hover:bg-slate-800 font-semibold gap-2">
                <PenTool className="w-5 h-5" />
